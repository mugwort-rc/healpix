...
$key = q/QUr/;
$external_labels{$key} = "$URL/" . q|intronode10.htm|; 
$noresave{$key} = "$nosave";

$key = q/eq:pixel_l/;
$external_labels{$key} = "$URL/" . q|intronode14.htm|; 
$noresave{$key} = "$nosave";
...
$key = q/cite_iau74/;
$external_labels{$key} = "$URL/" . q|intronode16.htm|; 
$noresave{$key} = "$nosave";
...
$key = q/QU:12/;
$external_labels{$key} = "$URL/" . q|intronode11.htm|; 
$noresave{$key} = "$nosave";

$key = q/eq:diff_eq/;
$external_labels{$key} = "$URL/" . q|intronode13.htm|; 
$noresave{$key} = "$nosave";
...
$key = q/fig:reftqu/;
$external_labels{$key} = "$URL/" . q|intronode12.htm|; 
$noresave{$key} = "$nosave";
...
$external_labels{$key} = "$URL/" . q|intronode8.htm|; 
$noresave{$key} = "$nosave";
...
$key = q/Pexpansion2/;
$external_latex_labels{$key} = q|A.3.1|; 
$noresave{$key} = "$nosave";
