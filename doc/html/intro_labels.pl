...
$key = q/Cls/;
$external_labels{$key} = "$URL/" . q|intro_HEALPix_conventions.htm|; 
$noresave{$key} = "$nosave";
...
$key = q/cite_ansari/;
$external_labels{$key} = "$URL/" . q|intro_Bibliography.htm|; 
$noresave{$key} = "$nosave";
...
$key = q/eq:cl_pixel/;
$external_labels{$key} = "$URL/" . q|intro_Pixel_window_functions.htm|; 
$noresave{$key} = "$nosave";
...
$key = q/eq:nest2uniq/;
$external_labels{$key} = "$URL/" . q|intro_Geometric_Algebraic_Propert.htm|; 
$noresave{$key} = "$nosave";
...
$key = q/fig:HEALPIX/;
$external_labels{$key} = "$URL/" . q|intro_Discretisation_Functions_on.htm|; 
$noresave{$key} = "$nosave";
...
$key = q/intro:fig:reftqu/;
$external_labels{$key} = "$URL/" . q|intro_HEALPix_conventions.htm|; 
$noresave{$key} = "$nosave";

$key = q/intro:polcconv/;
$external_labels{$key} = "$URL/" . q|intro_HEALPix_conventions.htm|; 
$noresave{$key} = "$nosave";
...
$key = q/intro:polcconv/;
$external_latex_labels{$key} = q|A.3.4|; 
$noresave{$key} = "$nosave";
...
$key = q/subsec:cmbfast/;
$external_latex_labels{$key} = q|A.2.1|; 
$noresave{$key} = "$nosave";
