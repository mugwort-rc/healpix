...
{\newpage\clearpage
\lthtmldisplayA{displaymath2226}%
\begin{displaymath}
...
{\newpage\clearpage
\lthtmldisplayA{displaymath2242}%
\begin{displaymath}
...
$\left({<br><br>tial T}/{<br><br>tial \theta}, {<br><br>tial T}/{<br><br>tial \phi}/\sin\theta \right) 
$%
\lthtmlinlinemathZ
\lthtmlcheckvsize\clearpage}
...
$\left({<br><br>tial^2 T}/{<br><br>tial \theta^2}, {<br><br>tial^2 T}/{<br><br>tial
...
$\left.{<br><br>tial^2 T}/{<br><br>tial \phi^2}/\sin^2\theta \right) $%
\lthtmlinlinemathZ
\lthtmlcheckvsize\clearpage}

{\newpage\clearpage
\lthtmlinlinemathA{tex2html_wrap_inline2796}%
$\left({<br><br>tial T}/{<br><br>tial \theta}, {<br><br>tial Q}/{<br><br>tial \theta}, {<br><br>tial
  U}/{<br><br>tial \theta}; {<br><br>tial T}/{<br><br>tial \phi}/\sin\theta, \ldots \right) 
$%
\lthtmlinlinemathZ
\lthtmlcheckvsize\clearpage}
...
$\left({<br><br>tial^2 T}/{<br><br>tial \theta^2},\ldots; {<br><br>tial^2 T}/{<br><br>tial
...
$\left.{<br><br>tial^2 T}/{<br><br>tial \phi^2}/\sin^2\theta \ldots \right) $%
\lthtmlinlinemathZ
\lthtmlcheckvsize\clearpage}
