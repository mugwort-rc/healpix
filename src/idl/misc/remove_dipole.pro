...
;
; -----------------------------------------------------------------------------
pro remove_dipole, map, weight, bad_data=bad_data, gal_cut = gal_cut, coord_in = u_coord_in, coord_out=u_coord_out, dipole = dipole, $
monopole=monopole, noremove=noremove, nside=nside_usr, onlymonopole=onlymonopole, $
ordering=ordering, pixel=pixel, $
units = units, help=help, silent=silent
;+
; NAME:
;   remove_dipole
;
...
syntax = 'remove_dipole, map, [weight, bad_data=, gal_cut=, coord_in=, coord_out=, dipole=, monopole=, noremove=, nside=, onlymonopole=, ordering=, pixel=, units=, help=, silent=]'
